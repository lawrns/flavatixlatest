      ...
      <Card>
        <CardContent>
          <div className="text-center py-8">
            ...
            <p className="text-sm text-fg-muted dark:text-fg-subtle">{error}</p>
            <button
              onClick={loadMetrics}
              className="mt-4 px-4 py-2 bg-primary text-white rounded-soft hover:bg-primary-600"
            >
              Retry
            </button>
          </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-fg dark:text-white">
            PWA Metrics Dashboard
          </h2>
        ...
        <button
          onClick={loadMetrics}
          disabled={loading}
          className="px-4 py-2 bg-primary text-white rounded-soft hover:bg-primary-600 disabled:opacity-50"
        >
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-fg-subtle mt-1">Last {timeRange} days</p>
              </div>
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-fg-subtle mt-1">Per user</p>
              </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-fg-muted dark:text-fg-muted">
                      Mobile
                    </span>
                  </div>
                  <span className="text-sm font-bold text-fg dark:text-white">
                    {formatPercentage(data.mobilePercentage)}
                  </span>
                </div>
                <div className="w-full bg-line dark:bg-bg-inset rounded-full h-3">
                  <div
              ...
              {/* Recommendation */}
              <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-soft">
            ...
            <div className="space-y-2">
              {data.dailyTrend.slice(-10).reverse().map((day) => (
                <div key={day.date} className="flex items-center justify-between">
                  <span className="text-xs text-fg-muted dark:text-fg-subtle w-20">
                  ...
                  <div className="flex-1 mx-4">
                    <div className="w-full bg-line dark:bg-bg-inset rounded-full h-2">
                      <div
                  ...
                  <span className="text-xs font-medium text-fg dark:text-white w-12 text-right">
                    {day.dau}
                  </span>
                </div>
              ))}
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* PWA Strength */}
              <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-soft">
              ...
              <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-soft">
              ...
              {/* Go Native */}
              <div className="p-4 bg-red-50 dark:bg-red-900/20 rounded-soft">
            ...
            {/* Current Assessment */}
            <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-soft">
