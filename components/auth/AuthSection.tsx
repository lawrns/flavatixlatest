      ...
      <div className="flex h-screen flex-col">
        <div className="flex-1">
          ...
          <div className="px-6 py-8 text-center">
            ...
            <p className="mt-2 text-zinc-600 dark:text-zinc-200">The one place for all your tasting needs</p>
          </div>
              ...
              <>
                ...
                <div className="flex gap-4">
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-3 rounded-lg bg-white dark:bg-zinc-800 px-4 py-3 font-bold text-zinc-900 dark:text-zinc-50 ring-1 ring-zinc-200 dark:ring-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-700 transition-colors"
                  >
                ...
                {mode === 'register' && (
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-zinc-300 dark:border-zinc-600 rounded-md bg-white dark:bg-zinc-800 text-zinc-900 dark:text-zinc-50 focus:border-primary focus:outline-none"
