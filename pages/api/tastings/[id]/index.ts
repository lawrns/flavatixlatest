...
// PATCH /api/tastings/[id] - Update a tasting (partial update)
...
export default createApiHandler({
  ...
  PATCH: withRateLimit(RATE_LIMITS.API)(withAuth(withValidation(updateTastingSchema, updateTastingHandler))),
