      ...
      <div className="max-w-xl mx-auto px-4 py-8">
        ...
        <div className="grid gap-6">
          ...
          <button
            ...
            className="surface-page p-8 border-2 border-line hover:border-primary hover:shadow-md transition-all group text-left rounded-pane"
          >
        ...
        {/* Features Section */}
        <div className="mt-12 surface-inset rounded-pane p-8">
        ...
        {/* Use Cases */}
        <div className="mt-8 surface-page rounded-pane p-8 border border-line">
          <h3 className="text-xl font-semibold text-fg mb-4">Perfect For</h3>
          <ul className="space-y-3">
            <li className="flex items-start gap-3">
              <span className="text-primary text-xl flex-shrink-0 ">•</span>
              <span className="text-fg-muted">
                <strong className="text-fg">Coffee Cuppings:</strong> Blind
            ...
            <li className="flex items-start gap-3">
              <span className="text-primary text-xl flex-shrink-0 ">•</span>
              <span className="text-fg-muted">
                <strong className="text-fg">Wine Competitions:</strong>{' '}
            ...
            <li className="flex items-start gap-3">
              <span className="text-primary text-xl flex-shrink-0 ">•</span>
              <span className="text-fg-muted">
                <strong className="text-fg">Educational Sessions:</strong>{' '}
            ...
            <li className="flex items-start gap-3">
              <span className="text-primary text-xl flex-shrink-0 ">•</span>
              <span className="text-fg-muted">
                <strong className="text-fg">Team Building:</strong> Friendly
