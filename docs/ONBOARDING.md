...
3. **Read:** `docs/ARCHITECTURE.md` - Architecture Patterns
...
2. **docs/COMPONENT_CATALOG.md** - UI component reference
3. **docs/API_REFERENCE.md** - API endpoints and examples
4. **docs/DATABASE.md** - Schema and RLS policies
...
- [ ] Read docs/ARCHITECTURE.md Executive Summary
